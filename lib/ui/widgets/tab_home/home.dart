    ...
    if (posts != null) {
      ...
      result = GestureDetector(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              AvatarWithNameWidget(viewModel: viewModel, avatarRadius: 20, user: post.author,),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  post!.postContent[pageIndex].likes == 0
                                      ? SizedBox.shrink()
                                      : Stack(
                                          children: <Widget>[
